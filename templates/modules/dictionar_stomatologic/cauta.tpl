...
<tr>
	<td  class="just_indent"><p>{MESSAGE}</p><br /><p>Introduceti cuvantul cautat si codul de siguranta iar noi va vom afisa rezultatle gasite cu privire la cautarea dvs.</p>
	</td>
</tr>
...
<td>
	...
	<table border="0" cellspacing="1" cellpadding="4">
		<tr>
			<td class="text2" valign="top"><b>Termen cautat:</b><span>*</span></td>
			<td><input type="text" name="titlu" value="{TITLU}" size="50"/> &nbsp;<p><i>numele termenului ex: dinte</i></p></td>
		</tr>
