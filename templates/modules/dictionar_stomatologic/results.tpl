...
<tr>
	<td ><p>Am gasit cuvantul cautat: {CUVANT_CAUTAT} in {NR_RESULTS} de definitii. Dati un click pe definitia dorita.</p>
	</td>
</tr>
...
<td>
		...
		<!-- BEGIN list_terms -->
		<tr>
		<td> <a href="{URL_LETTER}" title="{URL_TITLE_TERM}">{TITLU}</a></td>
		</tr><!-- END list_terms -->
		</table>
	</td>
</tr>
