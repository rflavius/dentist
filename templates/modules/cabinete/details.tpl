...
<div class="article_details">
	...
	<div class="article_details_contact ">
		...
		<p>
			...
			<span id='phone_details_ajax' style='width:225px;text-align:left;'>{SHORT_PHONE}&nbsp;&nbsp;<a onClick='displayPhoneNumber("{CAB_ID}","cabinet");'>vezi nr telefon</a></span>
			<span id='the_phone_div' class='hide_field'>{TELEFON}{FAX}</span>
		</p>
		<p><span><b>Website:</b></span>&nbsp;&nbsp;<span>{ADRESA_WEB}</span></p>
