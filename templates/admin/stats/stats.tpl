	...
	<tr>
		<td>
			...
			<table width="100%" class="grey" cellpadding="4" cellspacing="1">
				<tr>
					<td class="tbhead" colspan="10">Bilant:: ({NR_CONTRACTS}) Contracte</td>
				</tr>
				<tr>
				...
				<!-- BEGIN list_bilant -->
				<tr class="{BGCOLOR}">
					<td align="center" valign="top">{CAB_ID}</td>
					<td align="left" valign="top" nowrap>
						Proforma: [<a href="index.php?page=plati.viewproforma.{PROFORMA_ID}" target="_blank">{PROFORMA_ID}</a>]<br>
						Fiscala [<a href="index.php?page=plati.viewfiscala.{CONTRACT_ID}" target="_blank">{CONTRACT_ID}</a>]<br>
					</td>
				...
				<!-- END list_bilant -->
				<tr>
					<td colspan="10" class="row3" align="right" style="font-size:14px;">TOTAL: &nbsp;&nbsp;&nbsp;<b>{INCOME}</b> RON</td>
				</tr>
				<!-- <tr>
					<td colspan="10" class="row3" align="right" style="font-size:14px;">Castig agent marketing: &nbsp;&nbsp;&nbsp;<b>{MARKETING_COST}</b> RON</td>
				</tr> -->
			</table>
		</td>
	</tr>
