...
<table align="center" border="0" cellspacing="0" cellpadding="0" width="97%">
	<tr>
		<td>
			{INFORMATION}
			<form method="post" action="?page=pages.save_changes.{ID}" enctype="multipart/form-data">
				<table width="100%" class="grey" cellpadding="4" cellspacing="1">
					<tr>
						<td class="tbhead" colspan="2">Edit page : {LINK}{FILE_EXTENSION}</td>
					</tr>
					<tr>
					...
					<tr>
						<td class="{BGCOLOR1}" valign="top" align="center">
							<textarea name="content" id="cabinet_content" rows="45" cols="100">{CONTENT}</textarea>
						</td>
