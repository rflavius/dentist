...
<br>
<form method="post" action="?page=users.change_promovare" name='adauga_firma'>
<input type='hidden' name='firma_pachet' value='{SELL_PK}' id='firma_pachet'>
...
<input type='hidden' name='user_id' value='{USER_ID}'>
	...
	<table width="45%" class="grey" cellpadding="4" cellspacing="1">
		<tr>
			<td class="tbhead" colspan="2">Vizualizare/Modificare Tip Promovare</td>
		</tr>
		<tr> 
