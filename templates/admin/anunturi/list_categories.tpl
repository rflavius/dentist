	...
	<td valign="top" width="60%">
			...
			<table width="100%" class="grey" cellpadding="4" cellspacing="1">
				...
				<tr class="{BGCOLOR}">
					...
					<td><b>{CAT_NAME}</b></td>
					<td align="center">
						<a href="?page=anunturi.categories.set.{IMAGE_TITLE}.{CAT_ID}">
					<img src="../images/admin/{IMAGE}" title='Turn "{CAT_NAME}" category to {IMAGE_TITLE}'>
						</a>
					</td>
					<td align="center">
						<a href="?page=anunturi.categories.edit.{CAT_ID}"><img src="../images/admin/edit.png" title='Edit "{CAT_NAME}" category'></a>
					</td>
					<td align="center">
						<a onclick="return confirmSubmit()" href="?page=anunturi.categories.delete.{CAT_ID}">
			...
			<td valign="top">
			<form method="post" action="?page=anunturi.categories.add">
				<table width="100%" class="grey" cellpadding="4" cellspacing="1">
					<tr>
						<td class="tbhead" colspan="10">Add anunturi category </td>
					</tr>
					<tr class="{BGCOLOR1}">
