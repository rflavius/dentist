...
<!--
	function redirect()
	{
			document.location.href = "index.php?page=anunturi.recomandate."+document.anunturiform.select_cat.value+"."+document.anunturiform.select_status.value;
	}
		...
		<td>
			...
			<table align="center" class="tbpagination" cellspacing="{CS}" cellpadding="{CP}" width="100%">
				<tr>
					...
					<td class="{B1}" width="50"><strong>Recomanded: </strong></td>
			...
			<table width="100%" class="grey" cellpadding="4" cellspacing="1">
				...
				<tr>
					...
					<td class="bgmain" width="8%" nowrap>Visits <a href="?page={PAGE_NAME}&displaymode=vizite-nr_visits-ASC">
							<img src="../images/admin/down.png" title="Ascending A to Z">
						</a>&nbsp;
					...
					<td class="bgmain" width="8%" nowrap>On first page</td>
				...
				<td valign="top" align="center">{DATE_ADDED}</td>
					...
					<td align="center" valign="top">
						<a href="?page=anunturi.set_recomandat.{IMAGE_REC_TITLE}.{ID}">
					<img src="../images/admin/{IMAGE_REC}" title='Show "{TITLU}" on first page'>
						</a>
					</td>
