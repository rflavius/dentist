...
<table align="center" border="0" cellspacing="0" cellpadding="0" width="80%">
	<tr>
		<td>
			{INFORMATION}
			<form method="post" action="?page=news.save_changes.{ID}"  enctype="multipart/form-data">
				<table width="100%" class="grey" cellpadding="4" cellspacing="1">
					<tr>
						<td class="tbhead" colspan="10">Edit cursuri,evenimente,conferinte</td>
					</tr>
					<tr>
						<td width="50%" class="{BGCOLOR2}"><b>News title</b><p class="star">*</p></td>
						<td width="50%" class="{BGCOLOR1}">
							<input type="text" name="title" value="{TITLE}" size="120"/>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td class="{BGCOLOR2}"><b>Data evenimentului</b> format 2008-03-23 an/ll/zi</td>
