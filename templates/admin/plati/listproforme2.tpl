...
<table align="center" border="0" cellspacing="0" cellpadding="0" width="99%">
		...
		<td>
			...
			<table width="100%" class="grey" cellpadding="4" cellspacing="1">
				...
				<tr>
					...
					<td class="bgmain" >Trimisa prin e-mail</td>
					<td class="bgmain" width="7%">Cost</td>
					<td class="bgmain" width="7%">Expirata</td>
					<td class="bgmain" width="7%">Actions</td> 
				</tr>
				<!-- BEGIN list_messages -->
				<tr class="{BGCOLOR}">
					<td valign="top">Prof: [ <b>{ID}</b> ]<br>
					Fisc: [ <b>{FACTURA_FISALA_ID}</b> ]
					</td>
					<td valign="top"><b>{USERNAME}</b></td>
					<td valign="top"> {NUME_FIRMA}</td>
					<td valign="top">{TYPE}</td>
					<td valign="top">{AN_FACTURA}</td>
					<td valign="top"><b {CLASSNOTPAYED}>{ACHITAT}</b></td>
					...
					<td align="center" valign="top">
						<a href="?page=plati.viewproforma.{ID}">[ View ]</a><br />
						<a href="?page=plati.trimiteproforma.{ID}">[ Trimite ]</a>
					</td>
				</tr>
				<!-- END list_messages -->
				<!-- END if_messages -->
	...
	<br /><br />
	<ol>
		<li>Expirata <b style="color:red">activ</b> insemna ca factura proforma a fost achitata sau inca nu a expirat . </li>
		<li>Expirata <b style="color:red">inactiv</b> factura proforma a expirat, si nu a fost platita.</li>
		<li >Trimisa prin e-mail <b style="color:red">N</b> insemna ca factura proforma nu a fost trimisa clientului!! . </li>
		<li>Data Expirari se refera la expirarea facturii proforme (5 zile lucratoare de la data emiterii).</li>
