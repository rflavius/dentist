	...
	<tr>
		<td>
			...
			<table border="0" cellspacing="0" cellpadding="0" width="100%">
				<tr>
					<td valign="top">
						<form method="post" action="?page=contact.insert">
							<table width="100%" class="grey" cellpadding="4" cellspacing="1" border="0">
								<tr>
									<td class="tbhead" colspan="10">Add custom form field</td>
								</tr>
								<tr>
								...
								<tr>
									<td class="row2" valign="top"><b>Error message</b><p class="star">*<br /> if field is required</p></td>
									<td class="row1">
