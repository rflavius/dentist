...
<!-- BEGIN error -->
<div class="error" style="border:#990000;">{ERROR_MSG}</div>
<br>
<!-- END error -->
...
<table border="0" cellpadding="4" cellspacing="1" width="100%" class="big_table form" >
  <tr> 
		<td colspan="2" class="table_subhead">Adauga anuntul tau cu privire la facilitatile, serviciile, produsele oferite </td>
</tr>
 <tr> 
		<td class="row1" colspan="2">Complectati formularul de mai jos si anuntul dvs. va fi publicat pe site-ul nostru, dar intai acesta va fi verificat de administrator.</td>
</tr>
<tr> 
	<td class="row2" width="30%">Categoria: <span>*</span></td>
		<td class="row2">
...
<tr> 
		<td class="row2">Autor:<span>*</span></td>
		<td class="row2"><input name="autor" size="42"  value="{AUTOR}" type="text" ></td>
</tr> 
<tr> 
...
<tr> 
	<td class="row2">Judet: <span>*</span></td>
	<td class="row2">
...
<tr> 
	<td class="row2">Descriere anunt(date contact):<span>*</span> 
	<br>
	...
	<td class="row2"> <textarea name="continut_anunt" rows="15" cols="50" onkeydown="CountChars(continut_anunt, 1500)">{CONTINUT_ANUNT}</textarea>
	<br />Caractere disponibile :<input readonly type="text" name="caractere_continut_anunt" size="3" value="1500">
	</td>
</tr>

<tr> 
	<td class="row1">Adauga imagine: <br />
	<font size="" color="ff0000">Anunturile cu imgine sunt promovate pe prima pagina! </font> </td>
	<td class="row1"><input type="file" name="imagine" size="30" ></td>
</tr>
<tr> 
...
<tr>
	<td> <li>Pe aceasta <b>adresa de email</b> veti primi oferte, mesaje cu privire la anuntul dvs.</li></td>
</tr>
<tr>
	<td>
	<li>Anuntul dvs. va ramane valabil timp de 6 luni,daca veti dori sa il stergeti aveti acesta posiblilitatea din meniul dvs. de membru al site-ului dentistonline.ro. </li></td>
</tr>
<!-- cu plata<tr>
...
<tr>
	<td class="row2"> Anunturile detaliate si cu <b>imagine</b> sunt postate pe <b>prima pagina</b> a site-ul nostru pentru o anumita perioada de timp.</td>
</tr>
<tr>
