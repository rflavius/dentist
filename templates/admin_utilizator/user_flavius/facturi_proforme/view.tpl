<table border="0" cellspacing="3" cellpadding="4" width="90%">
<tr>
...
<tr>
	<td>
		...
		<p>Va rugam sa realizati plata in termen de <b>{EXPIRARE_FACTURA_PROFORMA}</b> zile lucratoare de la orice banca prin ordin de plata.</p>
...
<tr>
	<td>
		<p>Activarea firmei dvs. se face in urma livrarii sumei in contul destinatie. Factura in original este trimisa dupa confirmarea platii, la sfarsitul lunii.</p> 
	</td>
</tr>
</table>
<p>- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -</p>
	...
	<td colspan="3">
		...
		<tr>
			<td width="50%">
					...
					<tr>
						<td width="30%"><b><u>Furnizor</u></b></td>
					...
					<tr>
						<td><b>Banca</b></td>
						<td>UniCredit Tiriac Bank Oradea</td>
					</tr>
					</table>
			</td>
				<td valign="top">
					<table cellspacing="1" cellpadding="3" > 
						<tr>
							<td width="20%"><b><u>Beneficiar</u></b></td>
							<td>{NUME_PERS_CONTACT}</td>
						</tr>
						...
						<tr>
							<td width="250" valign="top"><b>Adresa</b></td>
							<td>{ADRESA}</td>
						</tr>
					</table>
			</td>
...
<tr>
	<td>Nr. crt.</td>
	<td>Denumirea produselor sau serviciilor</td>
	<td>Pret</td>
</tr>
<tr>
	<td>1.</td>
